...
class ProductController extends Controller
{
    ...
    {
        $request->validate(['name'=>'required','price'=>'required','details'=>'required']);
    ...
    public function deleteForEver($id)
    {
       ...
       return Redirect()->route('product.trash')->with('succes','product deleted successfully');
    }
    ...
    public function backFromSoftDelete($id)
    {
       ...
       return Redirect()->route('products.index')->with('succes','product back successfully');
    }
}
